      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Book&Move Privacy Policy</h2>
          ...
          <div className="mb-12">
            <p className="text-lg text-gray-700 leading-relaxed">
              Book&Move ("we," "our," "us") respects your privacy. This Privacy Policy explains how we collect, use, and protect your information when you use our website and services.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <ul className="list-disc list-inside space-y-3 text-gray-700">
                ...
                <li>To connect you with independent moving service providers ("ISPs").</li>
          ...
          <div className="mb-12">
            ...
            <div className="bg-red-50 rounded-xl p-6">
              <ul className="list-disc list-inside space-y-2 text-red-800">
                ...
                <li>Book&Move never stores full credit card numbers.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <p className="text-gray-700">
                Book&Move does not share, sell, or link your information to outside websites or unrelated third parties. Your information is used only to manage bookings, process deposits, and connect you with Independent Service Providers (ISPs) through our platform.
              </p>
            </div>
          </div>
