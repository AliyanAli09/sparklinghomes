...
import { FiTruck, FiCalendar, FiAlertCircle, FiCheckCircle, FiClock, FiDollarSign, FiShield, FiUser, FiCheck } from 'react-icons/fi';
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 sm:py-4 space-y-3 sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="h-8 w-8 sm:h-10 sm:w-10 bg-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
                <FiTruck className="h-4 w-4 sm:h-6 sm:w-6 text-white" />
              </div>
              <div className="min-w-0 flex-1">
                <h1 className="text-lg sm:text-2xl font-bold text-gray-900 truncate">Mover Dashboard</h1>
           ...
           <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-xl shadow-sm p-6 border border-blue-200 mb-8">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               ...
               <div className="text-center">
                 ...
                 <p className="text-sm text-gray-600">
                   Pay $150/month to access job calendar and receive real-time alerts
                 </p>
               </div>
             ...
             <div className="flex items-center justify-between">
               <div className="flex-1">
                 ...
                 <p className="text-sm text-gray-600 mt-1">
                   {canAccessJobs 
                     ? 'Access available moving jobs in your service areas' 
                 ...
                 {hasActiveSubscription && (
                   <div className="mt-2 text-sm text-gray-700 bg-gray-50 p-2 rounded-lg border border-gray-200">
                     <div className="flex items-center justify-between">
                       ...
                       <span className="text-green-600 font-semibold">$150/month</span>
                     </div>
                   </div>
                 )}
               </div>
             ...
             <div className="flex items-start space-x-3">
               ...
               <div className="flex-1">
                 ...
                 <div className="bg-white rounded-lg p-4 border border-blue-200 mb-4">
                   <h4 className="font-medium text-blue-900 mb-3">What Your $150/month Subscription Includes:</h4>
                 ...
                 >
                   Activate Subscription - $150/month
                 </button>
               </div>
             </div>
           </div>
                 ...
                 <div className="bg-white rounded-lg p-4 border border-green-200 mb-4">
                   ...
                   <div className="space-y-3 text-sm text-green-800">
                     <div className="flex items-start space-x-3">
                       ...
                       <div>
                         <strong>Automatic Job Detection:</strong> When a customer submits a moving job in your service area, 
